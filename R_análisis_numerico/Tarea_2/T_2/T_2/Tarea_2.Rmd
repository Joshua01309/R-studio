...
my_colors<-c("Muestra 1"="dodgerblue","Muestra 2"="tomato2", "Valores 1"="firebrick", "Valores 2"="goldenrod")
...
graf_muestras<-ggplo()+
  geom_funtion(aes(color="Muestra 1"), fun=polif_m1, linewidth=1.2)+
  geom_funtion(aes(color="Muestra 2"), fun=polif_m1, linewidth=1.2)+
